...
def fetch_variants(blueprint_id, print_provider_id):
    ...
    if response.status_code == 404:
        print("Provider " + str(print_provider_id) + " ikke tilgjengelig for blueprint " + str(blueprint_id) + ", prover andre...")
        ...
        if pr.status_code == 200:
            ...
            if providers:
                ...
                print("Bruker provider " + str(alt_id) + ": " + providers[0].get("title", ""))
...
def generate_seo(design_name, product_type):
    ...
    prompt = (
        ...
        '{"title": "SEO title max 70 chars, include country, World Cup 2026, product type",'
...
def main():
    ...
    for product in PRODUCTS:
        ...
        if variants:
            print(product["name"] + ": " + str(len(variants)) + " varianter (provider " + str(actual_provider) + ")")
        else:
            print(product["name"] + ": ingen varianter funnet - hoppes over")
